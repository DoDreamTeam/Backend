...
class BookServiceTest {
    ...
    void testGetBooks() {
        ...
        // when
        Page<BookResponse> responses = bookService.getBooks(null, pageable, false, user);
    ...
    void testGetBooksByCategory() {
        ...
        // when
        Page<BookResponse> responses = bookService.getBooks("CATEGORY_CS", pageable, false, user); // call the correct method here
    ...
    void testSearchBooksByKeyword() {
        ...
        // when
        Page<BookResponse> responses = bookService.searchBooksByKeyword("Sample", pageable, user); // user를 인자로 넘김
    ...
    void testUpdateBook() {
        ...
        when(bookRepository.findById(1L)).thenReturn(Optional.of(existingBook)); // Relevant mock
    ...
    void testGetBook_Success() {
        ...
        // when
        BookResponse response = bookService.getBook(1L, user);
